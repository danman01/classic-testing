...
2.  Our rails application is going to model a contrived Pet/Owner relationship. 
    ...
    * email - required
    ...
    1.  Setup 'Pet Factory' and 'Owner Factory' and create 'has_many/belongs_to' associtation between Pet and Owner.
    2.  Use FactoryGirl 'sequence' to generate unique owner emails.     
    3.  Write Rspec tests. 
